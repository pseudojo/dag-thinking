...
> **현재 버전**: v0.38 (131 tests) | 최종 갱신: 2026-06-13
...
├── tests/               — 행위 기준 8개 파일, 131개 테스트 (§12.1 아키텍처)
